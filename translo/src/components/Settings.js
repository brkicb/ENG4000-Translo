...
class Settings extends Component {
	...
	onAddTranslator() {
		Actions.addTranslator();
	}

	onRemoveTranslator() {
		Actions.removeTranslator();
	}
	...
	render() {
		return (
			...
			>
				...
				<Separator />
				<HeaderWrapper>
					<Header headerText="Favorite Translators" />
				</HeaderWrapper>
				<Separator />
				<ButtonWrapper>	
					<TextButton onPress={this.onAddTranslator.bind(this)}>
						Add Translator
					</TextButton>
				</ButtonWrapper>
				<Separator />
				<ButtonWrapper>	
					<TextButton onPress={this.onRemoveTranslator.bind(this)}>
						Remove Translator
					</TextButton>
				</ButtonWrapper>
				<Separator />
